...
// @@protoc_insertion_point(message:MsgExecuteContract)
pub struct MsgExecuteContract {
    // message fields
    // @@protoc_insertion_point(field:MsgExecuteContract.sender)
    pub sender: ::std::string::String,
    // @@protoc_insertion_point(field:MsgExecuteContract.contract)
    pub contract: ::std::string::String,
    // @@protoc_insertion_point(field:MsgExecuteContract.msg)
    pub msg: ::std::vec::Vec<u8>,
    // @@protoc_insertion_point(field:MsgExecuteContract.funds)
    pub funds: ::std::vec::Vec<Coin>,
    // special fields
    // @@protoc_insertion_point(special_field:MsgExecuteContract.special_fields)
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                42 => {
                    self.funds.push(is.read_message()?);
                },
                tag => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14protos/example.proto\"w\n\x12MsgExecuteContract\x12\x16\n\x06sende\
    r\x18\x01\x20\x01(\tR\x06sender\x12\x1a\n\x08contract\x18\x02\x20\x01(\t\
    R\x08contract\x12\x10\n\x03msg\x18\x03\x20\x01(\x0cR\x03msg\x12\x1b\n\
    \x05funds\x18\x05\x20\x03(\x0b2\x05.CoinR\x05funds\"v\n\x1aMsgWithdrawDe\
    legatorReward\x12+\n\x11delegator_address\x18\x01\x20\x01(\tR\x10delegat\
    orAddress\x12+\n\x11validator_address\x18\x02\x20\x01(\tR\x10validatorAd\
