// use eris::asset::{Asset, AssetInfo, PoolInfo};
// use eris::factory::{
//     ExecuteMsg as FactoryExecuteMsg, InstantiateMsg as FactoryInstantiateMsg, FactoryConfig, PairType,
...
//         eris_token::contract::execute,
//         eris_token::contract::instantiate,
//         eris_token::contract::query,
//     ));
...
//             eris_pair::contract::execute,
//             eris_pair::contract::instantiate,
//             eris_pair::contract::query,
//         )
//         .with_reply_empty(eris_pair::contract::reply),
//     );
...
//         ContractWrapper::new_with_empty(
//             eris_factory::contract::execute,
//             eris_factory::contract::instantiate,
//             eris_factory::contract::query,
//         )
//         .with_reply_empty(eris_factory::contract::reply),
//     );
...
//     let msg = FactoryExecuteMsg::CreatePool {
//         asset_infos: [
//             AssetInfo::Token {
